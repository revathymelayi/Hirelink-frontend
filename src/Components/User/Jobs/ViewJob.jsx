...
const ViewJob = () => {
  ...
  //         console.log("Setting applied to true");
  //         setApplied(true);
  //       } else {
  ...
  const handleApply = async () => {
    ...
    try {
      ...
      if (error.response && error.response.data.message === "User has already applied for this job") {
        toast.error("You have already applied for this job.");
      }else{
        ...
        <div className="xl:w-3/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
          ...
          <div className="py-4 border-b border-gray-200 flex items-center justify-between">
            ...
            <div className="flex items-center justify-centre">
             ...
             {applied ? (
        <button className="text-blue-500 font-semibold focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800
        text-base
        flex
        items-center
        justify-center
