    ...
    <div>
      ...
      <div className="xl:w-3/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
        <div className="border-b border-gray-200 pb-6">
          ...
          {job.employer.companyName} ,{job.employer.city}
          </p>
          </Link>
        ...
        <div className="py-4 border-b border-gray-200 flex items-center justify-between">
          ...
          <div className="flex items-center justify-centre">
            <WorkOutlineOutlinedIcon
              ...
              className="mr-0.5   text-gray-600"
            />
            <p className="text-sm leading-none text-gray-600 mr-3">{job.jobtype}</p>
          </div>
        </div>
        <div className="py-4 border-b border-gray-200 flex items-center justify-between">
          <p className="text-base leading-4 text-gray-800">Experience Required</p>
          <div className="flex items-center justify-centre">
            <WorkOutlineOutlinedIcon
              style={{ fontSize: "small" }}
              className="mr-0.5   text-gray-600"
            />
            <p className="text-sm leading-none text-gray-600 mr-3">{job.experience} Years</p>
          </div>
        </div>
