    ...
    <div className="w-full h-full mt-10 ">
      <div className="flex flex-no-wrap ">
        <div
          ...
          className={`w-64 absolute sm:relative bg-[] shadow-md md:h-full flex-col justify-between ${
        ...
        >
          <div className="border-spacing-1">
            ...
            <ul className="mt-12 space">
              ...
              <li
                className={`flex w-full justify-between cursor-pointer items-center mb-6 ${
                  activeMenu === "myjobs" ? "bg-gradient-to-r from-sky-500 to-cyan-200" : ""
                }`}
              >
                <a
                  href="#"
                  onClick={() => setActiveMenu("myjobs")}
                  className="text-gray-700 font-semibold text-sm px-4 py-3"
                >
                  My Jobs
                </a>
