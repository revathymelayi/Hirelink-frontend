...
function ViewJob() {
    const job = useSelector((state) => state.jobDetails.jobInfo);
     console.log("job:",job)
     console.log("13:",job.employer[0].employerdetails.logo)
    return (
        <div className="md:flex mt-20 items-start justify-center py-1 2xl:px-20 md:px-6 px-4">
          ...
          <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-10">
            <div className="border-b border-gray-200 pb-6">
              <h1
                className="
                            ...
                            "
              >
                {job.employer[0].employerdetails.companyName}
              </h1>
            ...
            <div>
              ...
              <p className="text-base leading-6 mt-4 text-gray-600">
                {job.employer[0].employerdetails.userBio}
              </p>
