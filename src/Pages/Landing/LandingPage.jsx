    ...
    <div>
      <div className="section font-semibold px-4 h-20 sm:px-8 md:px-16 text-gray-800 fixed w-full top-0 flex header_section bg-white shadow z-10">
        ...
        <div className="sub_head ml-auto flex space-x-4 sm:space-x-8 my-auto">
          ...
          <Link to="/login">
            <button className="relative group overflow-hidden px-5 h-8 rounded-full flex space-x-2 items-center bg-gradient-to-r from-blue-500 to-purple-500 hover:to-blue-700">
              <span className="relative text-md text-white">Sign in</span>
            </button>
          </Link>
